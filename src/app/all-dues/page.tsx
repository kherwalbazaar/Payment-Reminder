        ...
        <div className="absolute inset-0 z-50 flex items-end justify-center">
          ...
          <div className="relative w-full bg-white rounded-t-[28px] p-6 pb-8 animate-slide-up">
            ...
            <div className="flex gap-3">
              <a
                href={`https://wa.me/91${selectedCustomer.mobile}?text=${encodeURIComponent(`Hi ${selectedCustomer.name}, this is a reminder from Kherwal Bazaar. You have a pending dues of ₹${selectedCustomer.amount.toLocaleString()} (${selectedCustomer.days} days overdue). Kindly clear it at the earliest. Thank you!`)}`}
                target="_blank"
              ...
              <a
                href={`sms:${selectedCustomer.mobile}?body=${encodeURIComponent(`Hi ${selectedCustomer.name}, this is a reminder from Kherwal Bazaar. You have a pending dues of ₹${selectedCustomer.amount.toLocaleString()} (${selectedCustomer.days} days overdue). Kindly clear it at the earliest. Thank you!`)}`}
